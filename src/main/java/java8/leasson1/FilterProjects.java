...
import java8.leasson1.predicate.ProjectLanguagePredicate;
import java8.leasson1.predicate.ProjectStarPredicate;
...
public class FilterProjects {
    ...
    public static void main(String[] args) {
        ...
        projects = filterLanguageAndStarProjects(data, "python", 1000);
